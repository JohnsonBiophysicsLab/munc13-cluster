...
deltac2a_file = '../odeSolution/deltac2b_cluster_munc13_copies.csv';
...
try
    ...
    if exist('wt_data', 'var') && exist('deltac2a_data', 'var')
        ...
        legend({'WT NO STIM', 'WT STIM', 'ΔC2B NO STIM', 'ΔC2B STIM'}, 'Location', 'southeast');
        % grid on;
...
print('../figures/Fig3_LipidBindingEffect_Dynamics', '-dpng', '-r300');
print('../figures/Fig3_LipidBindingEffect_Dynamics', '-dsvg');
